...
},
{
  ...
  id: 13,
  name: "Exfiltration",
  description: "Exfiltration is the process of extracting data from a compromised system to an external location. How will you execute the exfiltration of sensitive information?",
  phase: 'exfiltration',
  choices: [
    {
      id: 'T1020',
    ...
    },
    {
      ...
      description: "An adversary may exfiltrate data in fixed size chunks instead of whole files or limit packet sizes below certain thresholds to avoid triggering network data transfer threshold alerts.",
      baseDifficulty: 15,  // Medium difficulty
      successRateModifier: 0.8,
    },
    {
    ...
    {
      id: 'T1048.001',
      method: "Exfiltration Over Symmetric Encrypted Non-C2 Protocol",
    ...
    {
      id: 'T1048.002',
      method: "Exfiltration Over Asymmetric Encrypted Non-C2 Protocol",
    ...
    {
      id: 'T1048.003',
      method: "Exfiltration Over Unencrypted Non-C2 Protocol",
    ...
    {
      id: 'T1011',
      method: "Exfiltration Over Other Network Medium",
    ...
    {
      id: 'T1011.001',
      method: "Exfiltration Over Bluetooth",
    ...
    {
      id: 'T1567',
      method: "Exfiltration Over Web Service",
    ...
    {
      id: 'T1567.001',
      method: "Exfiltration to Code Repository",
    ...
    {
      id: 'T1567.002',
      method: "Exfiltration to Cloud Storage",
    ...
    {
      id: 'T1567.003',
      method: "Exfiltration to Text Storage Sites",
    ...
    {
      id: 'T1567.004',
      method: "Exfiltration Over Webhook",
    ...
    },
    {
      ...
      description: "Adversaries may exfiltrate data by transferring the data to another cloud account they control on the same service.",
      baseDifficulty: 16,  // Medium-High difficulty
      successRateModifier: 0.77,
    },
  ],
},
{
